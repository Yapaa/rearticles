...
import 'package:rearticles/app/modules/Register/views/register_view.dart';
    ...
    return Scaffold(
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(image: AssetImage(img_1), fit: BoxFit.cover),
        ),
        child: Center(
          child: Column(
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: UnderlineInputBorder(
                            borderSide: BorderSide(color: defaultColor)),
                        prefixIcon:
                            Icon(Icons.person_pin, color: defaultColor),
                      ),
                    ),
